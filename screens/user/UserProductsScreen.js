...
const UserProductsScreens = props => {
...
UserProductsScreens.navigationOptions = navData => {
    return{
    ...
    <Item title="Menu" iconName={Platform.OS === 'android' ? 'md-create' : 'ios-create'} onPress={() => {
...
export default UserProductsScreens;